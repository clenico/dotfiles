...
# . "/home/imagedpt/miniconda3/etc/profile.d/conda.sh"  # commented out by conda initialize
    else
# export PATH="/home/imagedpt/miniconda3/bin:$PATH"  # commented out by conda initialize
    fi
fi
unset __conda_setup
...
__conda_setup="$('/home/niccle27/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/niccle27/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/niccle27/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/niccle27/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
